# CLAUDE Multiplayer Guide (Historico)

Este arquivo foi substituido por `Assets/Claude.md`, `Assets/Gemini.md`,
`Assets/Codex.md` e `Assets/Diretrizes_Multiagente.md`.
